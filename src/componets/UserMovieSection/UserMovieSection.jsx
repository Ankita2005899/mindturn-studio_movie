                    ...
                    >
                      <div className="flex mb-1 transition ease-in-out delay-150">
                        ...
                        <div
                          ...
                          className="text-white w-10 h-10 2xl:w-14 2xl:h-14 border-[2px] 2xl:border-[3px] rounded-full p-2 mr-2 backdrop-blur-[1px] shadow-md ease-linear transition-all duration-150 hover:border-yellow-600 hover:text-yellow-600"
                        >
                          <svg
                      ...
                      <a class="hover:text-primary-600 text-shadow-xl shadow-yellow-700 text-white text-base 2xl:text-2xl transition duration-500 font-medium">
                ...
                {!isResultEmpty ? (
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="flex justify-center items-center w-11/12 ml-2 bg-yellow-700 text-white font-medium sm:font-bold text-xl px-16 md:text-xl  py-3 rounded shadow hover:shadow-lg hover:bg-yellow-900 outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
