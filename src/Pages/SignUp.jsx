                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className={
                        ErrorMessage
                          ? "bg-stone-700 text-white sm:text-sm rounded-sm border-2 border-yellow-700 focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:text-white "
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={
                        ErrorMessage
                          ? "bg-stone-700 text-white sm:text-sm rounded-sm border-2 border-yellow-700 focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                          : "bg-stone-700 text-white sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:text-white"
                      }
                      required=""
                    ></input>
                  ...
                  <button
                    ...
                    className={`w-full text-white ${
                      loader
                        ? `bg-stone-700`
                        : `bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-primary-300`
