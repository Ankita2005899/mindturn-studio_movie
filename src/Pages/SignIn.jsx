          ...
          <Fade>
            <div>
              <div className="p-6 space-y-4 md:space-y-6 sm:p-12">
                ...
                <h1 className="text-white text-2xl p-3 text-center border-2 border-yellow-700 rounded-sm">
                  Not Real MindTurn
                </h1>
                <form
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className={
                        ErrorMessage
                          ? "bg-stone-700 text-white sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 border-2 border-yellow-700  dark:placeholder-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-white"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={
                        ErrorMessage
                          ? "bg-stone-700 text-white sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  border-2 border-yellow-700 dark:bg-gray-700 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:text-white"
                  ...
                  <div>
                    {ErrorMessage && (
                      <h1 className="flex text-white font-bold p-4 bg-yellow-700 rounded text-center">
                        <svg
                  ...
                  <button
                    ...
                    className={`w-full text-white ${
                      loader
                        ? `bg-stone-700`
                        : `bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-primary-300`
