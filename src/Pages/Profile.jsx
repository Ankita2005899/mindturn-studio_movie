...
function Profile() {
  ...
  const handleSetCustomPic = () => {
    if (!customPicUrl.trim()) return;
    updateProfilePic(customPicUrl.trim());
    setCustomPicUrl("");
  };
        ...
        <Fade>
          <div className="bg-[#000000bf] p-5 md:p-12 rounded-md">
              ...
              <div>
                ...
                <div className="flex justify-between cursor-pointer mb-4 md:mb-8">
                  ...
                  <input
                    ...
                    className="text-sm border border-gray-400 rounded px-2 py-1 w-40"
                  />
                  <button
                    type="button"
                    onClick={handleSetCustomPic}
                    className="bg-yellow-700 hover:bg-yellow-800 text-white text-sm font-medium px-3 py-1 rounded"
                  >
                    Set
                  </button>
                </div>
            ...
            <div className="flex justify-between mt-4">
              <button
                onClick={SignOut}
                className="flex items-center border-[0.7px] border-white text-white font-medium sm:font-bold text-xs px-14 md:px-24 md:text-xl  py-3 rounded shadow hover:shadow-lg hover:bg-white hover:border-white hover:text-yellow-700 outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
              >
                <svg
              ...
              {userName != "" ? (
                <button
                  ...
                  className="flex items-center bg-yellow-700 text-white font-medium sm:font-bold text-xs px-10 md:px-16 md:text-xl  py-3 rounded shadow hover:shadow-lg hover:bg-white hover:text-yellow-700 outline-none focus:outline-none mr-3 mb-1 ease-linear transition-all duration-150"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
